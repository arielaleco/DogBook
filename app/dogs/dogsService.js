app.factory('dogsService', function ($log, $q, $http) {
    ...
    // function GetDogImageFromAPI(dogName){
    //     var asyncAction = $q.defer();
    ...
    function getOneDogImageFromAPI(dogIndex){
        var asyncAction = $q.defer();
        dogsArr[dogIndex].fetchingNow="fetching-now";   
        var oneDogUrl = "https://dog.ceo/api/breed/"+dogsArr[dogIndex].breed+ "/images/random";
       // dogsArr[dogIndex].fetchingNow="fetching-now";   
        $http.get(oneDogUrl).then(function (response) {    

            dogsArr[dogIndex].fetchingNow="no-fetch";                 
            var imageUrl = response.data.message;                
            dogsArr[dogIndex].imageUrl = imageUrl;
            asyncAction.resolve(dogIndex); 
    ...
    // function changeThisDogImage(dogIndex)
    // {
        
    //     dogsArr[dogIndex].imageUrl= "data:image/png;base64,";            

    //      GetDogImageFromAPI(dogsArr[dogIndex].breed).then(function (response) {    
    //         var imageUrl = response.data.message;   
    //         dogsArr[dogIndex].imageUrl= imageUrl                               
    //     }, function (error) {
    //         dogsArr[dogIndex].imageUrl= "data:image/png;base64,";            
    ...
    return {
      ...
      //  changeThisDogImage    : changeThisDogImage   ,
        getOneDogImageFromAPI : getOneDogImageFromAPI
